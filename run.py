...
def get_sales_data():
    ...
    via the terminal, which must be a stro=ing of 6 numbers separated
...
def calculate_surplus_data(sales_row):
    ...
    - negate surplus indicates extra made when stock was sold out.
    """
...
def update_worksheet(data, worksheet):
    ...
    Update the relevant worksheet witht he data provided
    """
